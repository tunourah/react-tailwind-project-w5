...
const Header = () => {
  ...
  const svg4 = (
    <span className="[&>svg]:h-5 [&>svg]:w-10 text-custom-brown hover:text-black">
      <svg
        xmlns="http://www.w3.org/2000/svg"
        fill="currentColor"
        viewBox="0 0 576 512"
